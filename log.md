...
2. **客户管理 (customer-management.html)**
   - 客户列表和钱包信息展示
   - 搜索筛选功能
   - 新增/编辑客户模态框
...
### [修改] 客户管理页面国际化升级 - 2024年
**修改内容：**
- 针对海外客户业务场景，对客户管理页面进行国际化改造
- 优化状态管理和交互体验
- 完善子级信息展示逻辑
- 增强金额字段的可读性
...
3. **权限体系设计**
   - **页面访问权限**：首页、客户管理、转账审核、信用额度、交易明细、权限配置
   - **客户管理权限**：查看客户、新增客户、编辑客户、导出客户、调整额度
...
3. **客户经理**
   - 成员数：10人
   - 权限：8项权限，主要是客户管理和查看功能
   - 描述：负责客户管理、交易明细查看等客户服务功能
...
## 项目概述
本项目为海外业务资产中台管理系统，旨在统一管理各子业务客户资产，提供高效的资金管理和审核服务。系统采用纯前端实现，使用HTML+CSS+JavaScript技术栈，支持响应式设计。
...
git add .
git commit -m "初始提交：资产中台管理系统完整版本，包含6个核心模块和完整文档"
